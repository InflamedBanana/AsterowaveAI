...
void surf (Input IN, inout SurfaceOutput o) 
{
	...
	half4 refrColor = tex2Dproj(_GrabTexture, IN.screenPos);
	o.Alpha = refrColor.a;
	float4 finalColor = lerp(float4(1,1,1,1),_Color,_Transparancy);
//	o.Albedo = refrColor.rgb * (finalColor *( distort) );
	o.Emission = refrColor.rgb * (finalColor *( distort) );
